          ...
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <h1 className="text-responsive-headline font-bold text-primary-600 dark:text-primary-500">
                {siteConfig.site_name || 'Asha.News'}
              </h1>
            </div>
          </div>
            ...
            <div className="ml-10 flex items-baseline space-x-4">
              {loading ? (
                ...
                <>
                  ...
                  <div className="h-4 w-14 bg-slate-200 dark:bg-slate-700 rounded animate-pulse"></div>
                  <div className="h-4 w-12 bg-slate-200 dark:bg-slate-700 rounded animate-pulse"></div>
                </>
              ) : (
                navigationItems
                  ...
                  .map((item, index) => (
                    <a
                      ...
                      } hover:text-primary-600 dark:hover:text-primary-500 px-3 py-2 rounded-md text-sm font-medium transition-colors`}
                    >
                      {item.name}
                    </a>
                  ))
        ...
        <div className="md:hidden animate-slide-in">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-surface-light dark:bg-surface-dark border-t border-slate-200 dark:border-slate-700">
            {loading ? (
              ...
              <>
                <div className="h-6 w-16 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mx-3 my-2"></div>
                <div className="h-6 w-20 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mx-3 my-2"></div>
                <div className="h-6 w-18 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mx-3 my-2"></div>
                <div className="h-6 w-16 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mx-3 my-2"></div>
              </>
            ) : (
              navigationItems
                  ...
                  <a
                    ...
                    className={`${
                      index === 0 
                        ? 'text-text-primary-light dark:text-text-primary-dark' 
                        : 'text-text-secondary-light dark:text-text-secondary-dark'
                    } hover:text-primary-600 dark:hover:text-primary-500 block px-3 py-2 rounded-md text-base font-medium transition-colors`}
