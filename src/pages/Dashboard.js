...
const OverviewTab = ({ user, usageLimit, hasSubscription }) => {
  const subscriptionTier = user?.subscription?.tier || 'free';
  const isPremium = hasSubscription('premium');
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold text-text-primary-light dark:text-text-primary-dark">
                {usageLimit.current || 0}
                {!isPremium && <span className="text-sm text-text-secondary-light dark:text-text-secondary-dark">/{usageLimit.limit}</span>}
              </span>
            </div>
            {!isPremium && (
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${Math.min((usageLimit.current / usageLimit.limit) * 100, 100)}%` }}
                />
              </div>
            )}
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-surface-elevated-light dark:bg-surface-elevated-dark rounded-xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-text-secondary-light dark:text-text-secondary-dark">Plan</span>
              <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                isPro ? 'bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-300' :
                isPremium ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300' :
        ...
        <div className="bg-surface-elevated-light dark:bg-surface-elevated-dark rounded-xl p-6">
          ...
          <div className="space-y-2">
            <button className="w-full text-left px-3 py-2 rounded-lg hover:bg-interactive-hover-light dark:hover:bg-interactive-hover-dark transition-colors text-text-primary-light dark:text-text-primary-dark">
              📝 Update Preferences
            </button>
            <button className="w-full text-left px-3 py-2 rounded-lg hover:bg-interactive-hover-light dark:hover:bg-interactive-hover-dark transition-colors text-text-primary-light dark:text-text-primary-dark">
              🔔 Manage Alerts
