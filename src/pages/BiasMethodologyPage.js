...
const BiasMethodologyPage = () => {
  ...
  useEffect(() => {
    const fetchPageContent = async () => {
      try {
        const response = await fetch('/api/cms/page-content?page=bias-methodology');
  ...
  // Use CMS content or fallback data
  const title = pageContent?.title || "How We Analyze Bias - AI Methodology";
  const description = pageContent?.meta_description || "Learn about Asha.News AI-powered bias analysis methodology using GPT-4 for political bias detection, emotional tone analysis, and factual content assessment.";
        ...
        <div className="space-y-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-text-secondary-light dark:text-text-secondary-dark max-w-3xl mx-auto">
              {pageContent?.summary || "Understanding our AI-powered approach to detecting political bias, emotional tone, and factual content in news articles."}
            </p>
          </div>
          ...
          {pageContent?.content && (
            <div className="bg-surface-light dark:bg-surface-dark rounded-lg p-8 border border-primary-200 dark:border-primary-700">
              <div 
                className="prose prose-lg max-w-none text-text-primary-light dark:text-text-primary-dark"
