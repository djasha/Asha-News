...
class FactCheckerService {
  ...
  async getClaimResults(claimId) {
    try {
      ...
      logger.error('Error getting claim results:', error);
      throw error;
    }
  }
  ...
  async analyzeClaimWithAI(claim, provider = 'auto') {
    try {
      ...
      logger.error('Error analyzing claim with AI:', error);
      throw error;
    }
  }
  ...
  async getSourceCredibility(sourceUrl) {
    try {
      ...
      logger.error('Error getting source credibility:', error);
      throw error;
    }
  }
  ...
  async performFactCheck(claim, options = {}) {
    try {
      ...
      logger.error('Error performing fact-check:', error);
      throw error;
    }
  }
