...
# VPS Directus Backup Script (Fixed Container Names)
...
# Correct container names based on your setup
...
COMPOSE_FILE=""
if [ -f "/opt/directus/docker-compose.yml" ]; then
    COMPOSE_FILE="/opt/directus/docker-compose.yml"
