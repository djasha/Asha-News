...
const TABLE_MAP = {
  ...
  mc_user_preferences: 'mc_user_preferences',
  mc_workspace_layouts: 'mc_workspace_layouts',
  mc_followed_regions: 'mc_followed_regions',
  mc_muted_rules: 'mc_muted_rules',
  mc_alert_actions: 'mc_alert_actions',
  mc_dispatch_queue: 'mc_dispatch_queue',
  mc_dispatch_log: 'mc_dispatch_log',
  mc_dispatch_metrics: 'mc_dispatch_metrics',
  mc_source_health_snapshots: 'mc_source_health_snapshots',
  mc_feed_filters: 'mc_feed_filters',
  mc_feed_cursor_state: 'mc_feed_cursor_state',
  mc_wm_resource_health: 'mc_wm_resource_health',
  mc_feed_events: 'mc_feed_events',
  mc_source_subscriptions: 'mc_source_subscriptions',
  pages: 'page_content',
};
